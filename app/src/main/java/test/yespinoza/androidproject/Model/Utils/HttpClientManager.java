...
public class HttpClientManager {
    //region Variables
    public static String URL_APP_BACKEND_API = "http://52.179.0.127:1011/APP_API/";

    public static  String BKN_CREATE_USER = "User/CreateUser";
    public static String BKN_GET_USER = "User/GetUser";
    public static String BKN_GET_USERS = "User/GetUsers";
    ...
    public static String BKN_REGISTER_DEVICE = "PushNotification/RegisterDevice";
    public static String BKN_SEND_NOTIFICATION = "PushNotification/Send";
    //endregion
